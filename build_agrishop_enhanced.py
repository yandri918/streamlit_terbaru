"""Script to build enhanced AgriShop HTML with all features."""
...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1>🛒 AgriShop - Marketplace Hasil Panen</h1>
    ...
    <script>
        ...
        function createProductCard(product) {
            ...
            const emoji = commodityEmojis[product.commodity] || '🌱';
            ...
            card.innerHTML = `
                ...
                <div class="product-info">
                    ...
                    <div class="product-quantity">📦 ${product.quantity_kg} kg tersedia</div>
                    <div class="product-location">📍 ${product.location.address || 'Lokasi tidak tersedia'}</div>
            ...
            let content = `
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; color: #4a5568;">
                        <div>👁️ ${product.views || 0} views</div>
                        <div>❤️ ${product.interests || 0} interests</div>
                    </div>
                </div>
...
print("✅ Enhanced AgriShop HTML created successfully!")
