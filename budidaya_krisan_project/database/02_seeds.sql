-- ============================================================
-- Budidaya Krisan Pro — Seed Data
-- Data Master Varietas Krisan Spray Jepang
-- ============================================================

INSERT OR IGNORE INTO varieties (id, name, type, origin, cycle_days, target_height_cm, flowers_per_stem, vase_life_days, market_grade_a_price, description)
VALUES
    ('v001', 'Fiji White',    'spray', 'Jepang', 112, 75, 10, 14, 28000, 'Bunga putih bersih, tangkai kuat, cocok dataran tinggi 1000-1500 mdpl'),
    ('v002', 'Fiji Yellow',   'spray', 'Jepang', 112, 72, 10, 14, 26000, 'Bunga kuning cerah, populer ekspor, tahan cuaca'),
    ('v003', 'Reagent White', 'spray', 'Jepang', 105, 70, 12, 16, 30000, 'Mutu premium, bunga padat, vase life terpanjang'),
    ('v004', 'Reagent Pink',  'spray', 'Jepang', 105, 70, 12, 16, 30000, 'Warna pink lembut, sangat diminati pasar bunga segar'),
    ('v005', 'Princess White','spray', 'Jepang', 110, 73, 8, 14, 25000, 'Bunga pompon kecil rapi, cocok rangkaian'),
    ('v006', 'Gold Princess', 'spray', 'Jepang', 110, 73, 8, 14, 25000, 'Warna golden, tahan layu, disukai florist'),
    ('v007', 'Benson White',  'spray', 'Jepang', 108, 72, 9, 15, 27000, 'Ketahanan tinggi terhadap Fusarium, stabil'),
    ('v008', 'Benson Yellow', 'spray', 'Jepang', 108, 72, 9, 15, 27000, 'Varian kuning dari Benson series, produktif');

-- Konfigurasi webhook default
INSERT OR IGNORE INTO webhook_config (id, webhook_url, is_enabled)
VALUES (1, '', 0);

-- Data Sampel Batch Budidaya
INSERT OR REPLACE INTO cultivation_batches (id, batch_code, variety_id, variety_name, planting_date, target_harvest_date, land_area_m2, plant_count, house_name, beds_count, bed_length_m, row_count, plant_spacing_cm, status, notes)
VALUES
...
-- Data Sampel Pertumbuhan Mingguan (Batch 1: House 1 - Fiji White, Minggu 1 s.d. 8)
INSERT OR REPLACE INTO growth_records (id, batch_id, batch_code, variety_name, week_number, recording_date, plant_height_cm, leaf_count, stem_diameter_mm, branch_count, bud_count, health_score, ai_grade, growth_deviation_pct, anomaly_detected, anomaly_type, temperature_c, humidity_pct, weather_condition, notes, status)
VALUES
...
-- Data Sampel Pertumbuhan Mingguan (Batch 2: House 2 - Fiji Yellow, Minggu 1 s.d. 4)
INSERT OR REPLACE INTO growth_records (id, batch_id, batch_code, variety_name, week_number, recording_date, plant_height_cm, leaf_count, stem_diameter_mm, branch_count, bud_count, health_score, ai_grade, growth_deviation_pct, anomaly_detected, anomaly_type, temperature_c, humidity_pct, weather_condition, notes, status)
VALUES
...
-- Data Sampel Hasil Panen (Batch 3: House 3 - Reagent Pink)
INSERT OR REPLACE INTO harvest_records (id, batch_id, batch_code, variety_name, harvest_date, total_stems, grade_a_stems, grade_b_stems, grade_c_stems, grade_a_price, grade_b_price, grade_c_price, gross_revenue, production_cost, net_profit, roi_pct, bep_per_stem, marketable_yield_pct, loss_rate_pct, notes)
VALUES
...
-- Data Detail Grading Panen Ikat-Based (Batch 3: Reagent Pink)
INSERT OR REPLACE INTO harvest_detail_grades (id, harvest_id, batch_code, warna, grade_key, grade_name, tipe, stems_per_ikat, jml_ikat, total_batang, harga_per_batang, harga_per_ikat, total_pendapatan)
VALUES
...
-- Data Jurnal Biaya Operasional (Batch 1: House 1)
INSERT OR REPLACE INTO cost_journal (id, batch_id, batch_code, tanggal, kategori, deskripsi, jumlah)
VALUES
