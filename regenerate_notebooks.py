"""
Regenerate notebooks with proper markdown formatting
"""
...
# Save notebooks
with open('notebooks/2_Yield_Prediction_Model.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook2, f, indent=2, ensure_ascii=False)

with open('notebooks/3_Price_Forecasting_Analysis.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook3, f, indent=2, ensure_ascii=False)

print("✅ Notebooks regenerated with proper formatting!")
print("Markdown will now display correctly in Jupyter")
