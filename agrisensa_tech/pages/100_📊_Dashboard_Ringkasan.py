...
if user and user.get('role') == 'superadmin':
    st.sidebar.divider()
    presentation_mode = st.sidebar.checkbox("🖥️ Mode Presentasi (Admin)", help="Tampilan bersih untuk proyektor/PDF.")
...
if presentation_mode:
    ...
    st.markdown("""
        ...
        <div class="watermark">AGRISENSA OFFICIAL REPORT • CONFIDENTIAL</div>
    """, unsafe_allow_html=True)
    
    # Simple Header for Print
    st.markdown("## 📑 Laporan Eksekutif AgriSensa")
